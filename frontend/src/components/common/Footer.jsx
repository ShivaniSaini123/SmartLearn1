        ...
        <div className="bg-richblack-800 mx-7 rounded-3xl mb-10">
            ...
            <div className="border-b w-[100%] flex flex-col lg:flex-row pb-5 border-richblack-700">
                ...
                <div className="lg:w-[50%] flex flex-wrap flex-row justify-between lg:border-r lg:border-richblack-700 pl-3 lg:pr-5 gap-3">
                    ...
                    <img src={smartLearnLogo} alt="" className="object-contain" />
            ...
            <div className="flex flex-row items-center justify-between w-11/12 max-w-maxContent text-richblack-400 mx-auto pb-14 text-sm">
              ...
              return (
                ...
                <div className="text-center flex flex-col sm:flex-row ">
                    ...
                    <Link to='https://github.com/ShivaniSaini123' target="__blank" className="text-white hover:underline mr-1"
              >
                Shivani Saini
              </Link>
                    </div>
                    <span> © 2024 Smartlearn</span>
                </div>
                <div className="flex items-center">
                <a href="https://www.linkedin.com/in/shivani-saini-79193728b/" className="text-white p-3 hover:bg-richblack-700 rounded-full duration-300" target="_blank" rel="noopener noreferrer">
              <ImLinkedin2 size={17} />
            </a>
            <a href="https://github.com/ShivaniSaini123" className="text-white p-3 hover:bg-richblack-700 rounded-full duration-300" target="_blank" rel="noopener noreferrer">
              <ImGithub size={17} />
            </a>
                </div>
              </div>
